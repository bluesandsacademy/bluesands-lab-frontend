    ...
    <div className="p-1 md:p-3 lg:p-4 gap-6 flex flex-col">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-md gap-2 md:gap-3 p-2 md:p-3 lg:p-4">
        ...
        <button
          ...
          className="mt-3 md:mt-6 bg-[#303C48] text-white w-full p-2 text-sm lg:text-base rounded flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
        >
