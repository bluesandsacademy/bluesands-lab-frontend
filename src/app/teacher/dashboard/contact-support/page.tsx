                ...
                <div className="p-1 md:p-3 lg:p-4 gap-6 flex flex-col">
                  <div className="border border-gray-200 rounded-md flex flex-col gap-2 md:gap-3 p-2 md:p-3 lg:p-4">
                    ...
                    <a href="tel:+2347034194669">
                      <div className="border border-gray-200 rounded-md flex flex-col gap-2 md:gap-3 p-2 md:p-3 lg:p-4">
                        <div className="flex gap-4">
                          <FaPhoneAlt className="text-[#303C48] text-xl lg:text-2xl" />
                          <p className="text-sm lg:text-base font-semibold">
                            Phone Support
                          </p>
                        </div>
                        <p className="text-xs text-gray-600">
                          Call us at +234 703 419 4669
                        </p>
                    ...
                    <a href="mailto:support@bluesandstemlabs.com">
                      <div className="border border-gray-200 rounded-md flex flex-col gap-2 md:gap-3 p-2 md:p-3 lg:p-4">
                        <div className="flex gap-4">
                          <MdEmail className="text-[#303C48] text-xl lg:text-2xl" />
                          <p className="text-sm lg:text-base font-semibold">
                            Email Support
                          </p>
                        </div>
                  ...
                  <form
                    action="submit"
                    className="bg-white rounded-md gap-2 md:gap-3 p-2 md:p-3 lg:p-4"
                  >
                    <p className="text-sm lg:text-base font-semibold">
                    ...
                    <button
                      type="submit"
                      disabled
                      className="mt-3 md:mt-6 bg-[#303C48] text-white w-full p-2 text-sm lg:text-base rounded"
                    >
                      Submit
                    </button>
                  </form>
