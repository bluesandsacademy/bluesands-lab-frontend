          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col md:flex-row bg-blue-50 rounded-md justify-between p-2 md:p-3 text-xs md:text-sm">
                ...
                <div className="flex flex-col gap-1 md:gap-2">
                  ...
                  <div className="flex gap-2 items-center">
                    <div className="bg-gray-300 h-2 rounded-full w-40 overflow-hidden">
                      <div className={`h-full bg-bgBlue`} style={{ width: `${completedExp * 10}%` }}></div>
                    </div>
                    <p>{completedExp}/10</p>
                  </div>
                </div>
              ...
              <div className="flex flex-col items-end">
                ...
                { completedExp >= 10 && <div className="flex items-center gap-2 text-green-600">
                    <ImCheckmark2 />
                    <p>Completed</p>
                  </div> }
              </div>
            ...
            <div className="flex flex-col md:flex-row bg-blue-50 rounded-md justify-between p-2 md:p-3 text-xs md:text-sm">
              <div className="flex gap-2 md:gap-6">
                ...
                <div className="flex flex-col gap-1 md:gap-2">
                  ...
                  <div className="flex gap-1 md:gap-2 items-center">
                    <div className="bg-gray-300 h-2 rounded-full w-40 overflow-hidden">
                      <div className={`h-full bg-bgBlue`} style={{ width: `${completedExp * 5}%` }}></div>
                    </div>
                    <p>{completedExp}/20</p>
                  </div>
                </div>
              ...
              <div className="flex flex-col items-end">
                <p className="text-yellow-500">250 pts</p>
                 { completedExp >= 20 && <div className="flex items-center gap-2 text-green-600">
                    <ImCheckmark2 />
                    <p>Completed</p>
                  </div> }
              </div>
            ...
            <div className="flex flex-col md:flex-row bg-blue-50 rounded-md justify-between p-2 md:p-3 text-xs md:text-sm">
              <div className="flex gap-2 md:gap-6">
                ...
                <div className="flex flex-col gap-1 md:gap-2">
                  ...
                  <div className="flex gap-2 items-center">
                    <div className="bg-gray-300 h-2 rounded-full w-40 overflow-hidden">
                      <div className={`h-full bg-bgBlue`} style={{ width: `${currentStreak * 33.333}%` }}></div>
                    </div>
                    <p>{currentStreak}/3</p>
                  </div>
                </div>
              ...
              <div className="flex flex-col items-end">
                <p className="text-yellow-500">75 pts</p>
                 { currentStreak >= 3 && <div className="flex items-center gap-2 text-green-600">
                    <ImCheckmark2 />
                    <p>Completed</p>
                  </div> }
              </div>
            ...
            <div className="flex flex-col md:flex-row bg-blue-50 rounded-md justify-between p-2 md:p-3 text-xs md:text-sm">
              <div className="flex gap-2 md:gap-6">
                ...
                <div className="flex flex-col gap-1 md:gap-2">
                  ...
                  <div className="flex gap-2 items-center">
                    <div className="bg-gray-300 h-2 rounded-full w-40 overflow-hidden">
                      <div className={`h-full bg-bgBlue`} style={{ width: `${currentStreak * 14.29}%` }}></div>
                    </div>
                    <p>{currentStreak}/7</p>
                  </div>
                </div>
              ...
              <div className="flex flex-col items-end">
                <p className="text-yellow-500">200 pts</p>
                 { currentStreak >= 7 && <div className="flex items-center gap-2 text-green-600">
                    <ImCheckmark2 />
                    <p>Completed</p>
                  </div> }
              </div>
            ...
            <div className="flex flex-col md:flex-row bg-blue-50 rounded-md justify-between p2 md:p-3 text-xs md:text-sm">
              <div className="flex gap-2 md:gap-6">
                ...
                <div className="flex flex-col gap-1 md:gap-2">
                  ...
                  <div className="flex gap-2 items-center">
                     <div className="bg-gray-300 h-2 rounded-full w-40 overflow-hidden">
                      <div className={`h-full bg-bgBlue`} style={{ width: `${currentStreak * 3.333}%` }}></div>
                    </div>
              ...
              <div className="flex flex-col items-end">
                <p className="text-yellow-500">1000 pts</p>
                 { currentStreak >= 30 && <div className="flex items-center gap-2 text-green-600">
                    <ImCheckmark2 />
                    <p>Completed</p>
                  </div> }
              </div>
