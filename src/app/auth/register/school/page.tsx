        ...
        <>
            <section className="min-h-screen p-3 mb-10">
                ...
                <form className='border max-w-2xl mx-auto flex flex-col gap-y-5 py-5 px-10 rounded-lg shadow-sm mt-0 md:-mt-28 z-30 relative bg-white'>
                    ...
                    <div className='flex flex-col w-full gap-y-4'>
                        <label htmlFor="emailAddress" className='font-medium text-gray-700 text-md'>School Email Address</label>
                    ...
                    <div className='flex flex-col w-full gap-y-4'>
                        <label htmlFor="position" className='font-medium text-gray-700 text-md'>Position</label>
                        <select className='rounded-md border px-3 py-3 w-full text-gray-600' id="position">
                            {workPositions.map((option, index) => (<option value={option} key={index}>{option}</option>))}
                        </select>
                    </div>
                    <div className='flex flex-col w-full gap-y-4'>
                        <label htmlFor="totalNoOfStudents" className='font-medium text-gray-700 text-md'>Total Number of Students</label>
                        <input type="number" placeholder="Number of Students" className='rounded-md border px-3 py-3 w-full text-gray-600' id='totalNoOfStudents' min={0} />
                    </div>
                    <div className='flex flex-col w-full gap-y-4'>
