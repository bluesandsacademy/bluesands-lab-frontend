        ...
        <section className="min-h-screen p-3">
            <div className='w-full flex justify-center relative z-0'>
                ...
                <div className="absolute text-center text-white max-w-lg md:bottom-36 bottom-5 space-y-3">
                    <h1 className="text-2xl md:text-4xl font-normal">Get Started</h1>
                    <p className="font-thin md:text-lg text-sm md:max-w-lg max-w-xs">Choose your role to begin your journey on Blue Sands STEM Labs.</p>
                </div>
            </div>
