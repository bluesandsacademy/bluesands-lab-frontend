...
const SubscriptionStatus = () => {
  const {user} = useUser()
  return (
    <div className={user?.role?.toLowerCase() === "teacher" ? "hidden" : "m-3 flex flex-col gap-4 md:gap-6 lg:gap-10 bg-white p-2 lg:p-12 rounded-md"}>
        ...
        <div>
            <Link href={user?.role?.toLowerCase() === "schooladmin" ? "/school/dashboard/payments" : "/dashboard/profile/subscriptions"}>
