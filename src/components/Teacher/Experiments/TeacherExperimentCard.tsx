      ...
      <div className="bg-white rounded-md p-2 flex flex-col gap-4 w-max md:w-[30rem]">
          ...
          <div>
            <div className="flex flex-col gap-2 md:gap-0">
              <div className="flex flex-col md:flex-row md:justify-between">
                ...
                <button onClick={handleAddClick} className="bg-teal-600 text-white rounded p-1 px-2 text-xs w-max">
                  Assign
                </button>
              </div>
        ...
        <div>
          {keywords?.map((keyword, index) => (
            <p
              className="bg-gray-200 rounded-full text-gray-600 p-1 px-2 text-xs w-max"
              key={index}
            >
              {keyword}
            </p>
