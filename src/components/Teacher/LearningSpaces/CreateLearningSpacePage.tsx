...
//                 }`}
//             >
//               {isCompleted ? <FaCheck className="w-3.5 h-3.5" /> : index + 1}
//             </div>
//             <span
...
//       onSuccess? router.push("/teacher/dashboard/classes/learning-space"): null
//     } catch (error: any) {
//       toast.error(
//         <div>
...
//                 </div>
//                 <div>
//                   <h1 className="text-sm font-bold text-gray-900 leading-none">Create Learning Space</h1>
//                   {formData.title && (
...
//           {/* Two-column layout on step 0 (form + resources), single column otherwise */}
//           <div className={`flex gap-8 ${showResourcesPanel ? "flex-col lg:flex-row" : ""}`}>
//             {/* ── Form column ──────────────────────────────────────────── */}
//             <div
//               ref={scrollContainerRef}
//               className={`flex-1 space-y-5 overflow-y-auto ${showResourcesPanel ? "lg:max-h-none" : ""}`}
//             >
//               {/* ── Step 0: Setup ── */}
//               {currentStep === 0 && (
//                 <>
...
//               {/* ── Footer navigation ─────────────────────────────────────── */}
//               <div className="flex items-center justify-between pt-4 pb-8 border-t border-gray-200 mt-2">
//                 {/* Mobile save draft */}
//                 <button
//                   onClick={handleSaveDraft}
//                   disabled={isSavingDraft || isLoading}
//                   className="sm:hidden flex items-center gap-1.5 px-3 py-2 text-xs border border-gray-300 rounded-lg hover:bg-gray-50 text-gray-600 font-medium disabled:opacity-50"
//                 >
//                   {isSavingDraft ? <FaSpinner className="animate-spin w-3 h-3" /> : <FaSave className="w-3 h-3" />}
//                   Save Draft
//                 </button>
...
//                     className="flex items-center gap-2 px-4 py-2 text-sm border border-gray-300 rounded-lg hover:bg-gray-50 text-gray-700 transition-colors"
//                   >
...
//                     <button
//                       onClick={handleNext}
//                       className="flex items-center gap-2 px-5 py-2 text-sm bg-blue-950 text-white rounded-lg hover:bg-blue-800 active:scale-95 transition-all"
//                     >
//                       Next
//                       <FaChevronRight className="w-3 h-3" />
//                     </button>
...
//                       className={`flex items-center gap-2 px-5 py-2 text-sm rounded-lg text-white transition-all
//                         ${isLoading ? "bg-blue-800 cursor-not-allowed" : "bg-blue-950 hover:bg-blue-800 active:scale-95"}
//                         disabled:opacity-50`}
//                     >
//                       {isLoading ? (
//                         <><FaSpinner className="animate-spin w-4 h-4" /> Publishing…</>
//                       ) : (
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="flex-1 max-w-screen-xl mx-auto w-full px-4 sm:px-6 py-8">
          ...
          {/* Two-column layout on step 0 (form + resources), single column otherwise */}
          <div
            className={`flex gap-8 ${showResourcesPanel ? "flex-col lg:flex-row" : ""}`}
          >
            {/* ── Form column ──────────────────────────────────────────── */}
            <div
              ref={scrollContainerRef}
